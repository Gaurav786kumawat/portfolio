// ✅ Windows-safe fix (handles quotes in path)
import fs from "fs";
...
export default function BlogPage() {
    // 🧠 Normalize full path manually (so quotes won't break)
    // 🧩 Manually fix absolute path (since 'GAURAV' has quotes in folder name)
    const postsDir = "C:\\Users\\'GAURAV'\\Desktop\\portfolio\\src\\app\\blog\\posts";


    console.log("✅ Looking for posts at:", postsDir);
