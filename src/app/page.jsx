...
export const metadata = {
  title: 'Gaurav Kumawat - Full Stack Developer | MERN Stack & Next.js Expert',
  description: 'Full Stack Developer specializing in MERN Stack, Next.js, React, Node.js, and DSA. Building scalable web applications with modern technologies. 150+ DSA problems solved. Available for freelance and full-time opportunities.',
  keywords: 'full stack developer, MERN stack developer, Next.js developer, React developer, Node.js developer, web developer, JavaScript developer, TypeScript, MongoDB, Express.js, Gaurav Kumawat, DSA, frontend developer, backend developer, portfolio',
  ...
  openGraph: {
    ...
    title: 'Gaurav Kumawat - Full Stack Developer | MERN Stack & Next.js Expert',
    description: 'Full Stack Developer specializing in MERN Stack, Next.js, React, Node.js, and DSA. Building scalable web applications with modern technologies.',
    images: [
      {
        url: 'https://portfolio.gauravkumawat.online/images/profile.png',
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: 'Gaurav Kumawat - Full Stack Developer | MERN Stack & Next.js Expert',
    description: 'Full Stack Developer specializing in MERN Stack, Next.js, React, Node.js, and DSA. Building scalable web applications with modern technologies.',
    images: ['https://portfolio.gauravkumawat.online/images/profile.png'],
